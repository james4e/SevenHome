...
!function (a) {
    function b(b, d, e) {
        ...
        j.transitionPrefix = k[ModernizrForSequence.prefixed("transition")], j.animationPrefix = k[ModernizrForSequence.prefixed("animation")], j.transitionProperties = {}, j.transitionEnd = l[ModernizrForSequence.prefixed("transition")] + " " + l[ModernizrForSequence.prefixed("animation")], j.numberOfFrames = j.frames.length, j.transitionsSupported = void 0 !== j.transitionPrefix ? !0 : !1, j.hasTouch = "ontouchstart"in window ? !0 : !1, j.isPaused = !1, j.isBeingHoveredOver = !1, j.container.removeClass("sequence-destroyed"), j.paused = function () {
        }, j.unpaused = function () {
        ...
        if (j.settings.windowLoaded === !0 && (c = j.settings.windowLoaded), void 0 === j.settings.preloader || j.settings.preloader === !1 || 0 === m && 0 === n)c === !0 ? (f(), a(this).unbind("load.sequence")) : a(window).bind("load.sequence", function () {
            ...
            var o = g(m), p = g(n, !0), q = a(o.concat(p));
            h(q, f)
        }
    }
    ...
    a(window).bind("load", function () {
        ...
        startAutoPlay: function (a) {
            ...
            window.ModernizrForSequence = function (a, b, c) {
                ...
                function i(a, b, c) {
                    var d = a.charAt(0).toUpperCase() + a.slice(1), f = (a + " " + t.join(d + " ") + d).split(" ");
