...
translation = {
    ...
    home: 'Home',
    /*=================HOME===================*/
    slide1header: 'The first O2O cross border education service platform',
    slide1body: 'No Barrier, No Agents, Low Fee',
    slide2: '',
    slide2body: 'We have the best mentor team in North America',
    slide2btn1: 'Find By School',
    slide2btn2: 'Find By Major',
    slide2btn3: 'Find By Subject',
    slide3header: 'Get the service that fits your personal requirements best',
    slide3body: 'Find the trusted & profession help oversea',
